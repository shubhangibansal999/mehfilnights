...
| CMS usability for non-technical editor | Monitoring | 4-type-only schema, Loom walkthrough planned |
...
| Accessibility compliance | Open | axe-core + Lighthouse on every PR; required alt text in Sanity; manual keyboard + VoiceOver pass Week 3 |
